    ...
    public double lineReader() {
        ...
        try {
            ...
            if (chooseGridClass == 35 || chooseGridClass == 110 || chooseGridClass == 150) {
                ...
                //count file rows
                br = new BufferedReader(new FileReader("D:\\GITSOFTSERVE\\softserve project\\ElectroCircle\\shortCurcuit\\src\\Program\\PowerGridInfo\\Grisd35-150kV.txt"));
                while (br.readLine() != null) {
                    count++;
                }

                sc = new Scanner(new FileReader("D:\\GITSOFTSERVE\\softserve project\\ElectroCircle\\shortCurcuit\\src\\Program\\PowerGridInfo\\Grisd35-150kV.txt"));
                ...
                //count file rows
                br = new BufferedReader(new FileReader("D:\\GITSOFTSERVE\\softserve project\\ElectroCircle\\shortCurcuit\\src\\Program\\PowerGridInfo\\Grids220-500kV.txt"));
                while (br.readLine() != null) {
                    count++;
                }

                sc = new Scanner(new FileReader("D:\\GITSOFTSERVE\\softserve project\\ElectroCircle\\shortCurcuit\\src\\Program\\PowerGridInfo\\Grids220-500kV.txt"));
                arrOfGrids = new String[count][4];
                for (int i = 0; i < count; i++) {
                    for (int j = 0; j < 4; j++) {
                        arrOfGrids[i][j] = sc.next();
