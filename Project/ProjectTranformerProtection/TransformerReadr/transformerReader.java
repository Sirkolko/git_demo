...
public class transformerReader {
       public static String [][] transformerReader () throws IOException {
              System.out.println("\nEnter transformer class (35,110,220) to choose transformer ");
              Scanner sc = new Scanner(System.in);
              int transformerClass = sc.nextInt();
              switch (transformerClass){
                  case 35:
                      sc = new Scanner(new File("src/Program/TransformerInfo/Transformer35kV.txt"));
                  break;
                  case 110:
                      sc = new Scanner(new File("src/Program/TransformerInfo/Transformer110kV.txt"));
                      break;
                  case 220:
                      sc = new Scanner(new File("src/Program/TransformerInfo/Transformer220kV.txt"));
                      break;
                  default:
