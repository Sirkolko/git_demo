...
public class MainApp {
    public static void main(String[] args) throws IOException {
        ...
        SystemParameters syst = new SystemParameters.SystemBuilder()
        ...
        double a = mathCalculation.shortCircleCurrentK1MaxCalc(syst);
        double b = mathCalculation.shortCircleCurrentK1MinCalc(syst);
